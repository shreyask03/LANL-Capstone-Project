...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_semantic = {"robot_description_semantic": _load_text("four_dof_arm_moveit_config", "config/four_dof_arm.srdf")}
    kinematics_yaml = _sanitize(_load_yaml("four_dof_arm_moveit_config", "config/kinematics.yaml"))
    ompl_yaml = _sanitize(_load_yaml("four_dof_arm_moveit_config", "config/ompl_planning.yaml"))
    joint_limits_yaml = _sanitize(_load_yaml("four_dof_arm_moveit_config", "config/joint_limits.yaml"))
    moveit_controllers_yaml = _sanitize(_load_yaml("four_dof_arm_moveit_config", "config/moveit_controllers.yaml"))
    initial_positions = _sanitize(_load_yaml("four_dof_arm_moveit_config", "config/initial_positions.yaml"))
